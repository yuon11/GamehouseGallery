...
public class EditProfile extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    ActivityResultLauncher<Intent> startCamera; //for starting an activity for result
    ActivityResultLauncher<Intent> startFileDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * The new way of starting and activity for result
         *
         * */
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        ...
                        if (result.getResultCode() == Activity.RESULT_OK) {
                            if(imageUri==null)
                            {
                                Toast.makeText(EditProfile.this, "Error taking photo.", Toast.LENGTH_SHORT).show();
                                return;
                            }
                            uploadImage();
        ...
        startFileDialog = registerForActivityResult(
                new ActivityResultContracts.StartActivityForResult(),
                new ActivityResultCallback<ActivityResult>() {
                    @Override
                    public void onActivityResult(ActivityResult result) {
